...
**"medium-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Medium's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** Medium changing its markup is expected —
